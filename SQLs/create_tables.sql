DROP TABLE if exit"AVATAR_IMAGE" CASCADE CONSTRAINTS;
DROP TABLE if exit"AT_USER" CASCADE CONSTRAINTS;
DROP TABLE if exit"COMMENT_ON_MESSAGE" CASCADE CONSTRAINTS;
DROP TABLE if exit"LIKES" CASCADE CONSTRAINTS;
DROP TABLE if exit"MESSAGE" CASCADE CONSTRAINTS;
DROP TABLE if exit"MESSAGE_COLLECTION" CASCADE CONSTRAINTS;
DROP TABLE if exit"MESSAGE_IMAGE" CASCADE CONSTRAINTS;
DROP TABLE if exit"MESSAGE_OWNS_TOPIC" CASCADE CONSTRAINTS;
DROP TABLE if exit"PRIVATE_LETTER" CASCADE CONSTRAINTS;
DROP TABLE if exit"RELATION" CASCADE CONSTRAINTS;
DROP TABLE if exit"TOPIC" CASCADE CONSTRAINTS;
DROP TABLE if exit"USER_PRIVATE_INFO" CASCADE CONSTRAINTS;
DROP TABLE if exit"USER_PUBLIC_INFO" CASCADE CONSTRAINTS;

DROP SEQUENCE if exit SEQ_AT_USER;
DROP SEQUENCE if exit SEQ_AVATAR_IMAGE;
DROP SEQUENCE if exit SEQ_COMMENT_ON_MESSAGE;
DROP SEQUENCE if exit SEQ_MESSAGE;
DROP SEQUENCE if exit SEQ_MESSAGE_IMAGE;
DROP SEQUENCE if exit SEQ_PRIVATE_LETTER;
DROP SEQUENCE if exit SEQ_TOPIC;
DROP SEQUENCE if exit SEQ_LIKES;
DROP SEQUENCE if exit SEQ_USER_PUBLIC_INFO;
------------Avatar_Image-------------
